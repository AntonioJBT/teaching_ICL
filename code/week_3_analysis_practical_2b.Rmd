...
These files are too big for GitHub, you'll need to download them from Blackboard Learn or generate them with the simulate scripts in the code directory.
```{r}
