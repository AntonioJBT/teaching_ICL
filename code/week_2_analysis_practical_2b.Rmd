---
title: "Data analysis practical QTLs - part 2b"
...
If you errors related to "vector memory exhausted" you can try the following solution:
[R on MacOS Error: vector memory exhausted (limit reached?) - Stack Overflow](https://stackoverflow.com/questions/51295402/r-on-macos-error-vector-memory-exhausted-limit-reached)

You can find more information here:
- [R: Get Environment Variables](https://stat.ethz.ch/R-manual/R-devel/library/base/html/Sys.getenv.html)
- [R: Set or Unset Environment Variables](https://stat.ethz.ch/R-manual/R-devel/library/base/html/Sys.setenv.html)
- [R: Memory Available for Data Storage](https://stat.ethz.ch/R-manual/R-devel/library/base/html/Memory.html)
...
Small files are on GitHub but you can create larger ones if wanted with the simulation scripts in the code directory.
See the README file in the data directory for a few more instructions.

```{r}
input_gex <- '../data/100_cont_var_sim_data.tsv'
input_SNP <- '../data/100_plink.A-transpose.matrixQTL.geno'
input_covariates <- '../data/100_cov_sim_data.tsv'
```
